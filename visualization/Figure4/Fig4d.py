...
"""
Fig4d
Violin plots comparing weekday changes in parameter 2A
...
Input data
----------
figure_data/Figure4/Fig4d/

Output
------
visualization/Figure4/Fig4d/
...
DATA_DIR = ROOT / "figure_data" / "Figure4" / "Fig4d"
OUTPUT_DIR = ROOT / "visualization"/ "Figure4" / "Fig4d"

OUTPUT_DIR.mkdir(exist_ok=True)

output_path = OUTPUT_DIR / "Fig4d.svg"
...
def load_data():
    ...
    for group, files in groups.items():
        ...
        for file in files:
            ...
            df = pd.read_csv(DATA_DIR / file, usecols=["Range"])

            df = df.rename(columns={"Range": "Value"})
...
ax.set_title("Range", fontsize=22)
...
print("Fig4d saved to:", output_path)