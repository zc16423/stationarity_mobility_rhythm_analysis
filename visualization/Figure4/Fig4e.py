...
"""
Fig4e
Weekly values of phase angle (φ) in 2020 weekdays.
...
Input data
----------
figure_data/Figure4/Fig4e/

Output
------
visualization/Figure4/Fig4e/
"""
...
DATA_DIR = ROOT / "figure_data" / "Figure4" / "Fig4e"
OUTPUT_DIR = ROOT / "visualization"/ "Figure4" / "Fig4e"

OUTPUT_DIR.mkdir(exist_ok=True)

output_path = OUTPUT_DIR / "Fig4e.svg"
...
# -------------------------
# Y axis formatting (time)
# -------------------------

ax.set_ylim(12, 15)

yticks = np.linspace(12, 15, 7)
...
print("Fig4e saved to:", output_path)