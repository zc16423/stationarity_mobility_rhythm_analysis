"""
Figure 2e — State-level Phase Angle Comparison by Race

This script generates the state-level comparison plot for the phase
angle parameter (φ), representing the timing of the mobility valley
in the daily mobility rhythm model.

Each state is represented by a horizontal line connecting the phase
values across racial groups.

Input
-----
CSV file located in:

figure_data/Figure2/Fig2e/Fig2e_phase_angle.csv
...
Time values must be formatted as:

    HH:MM

Output
------
visualization/Figure2/Fig2e/Fig2e_phase_state_comparison.svg
...
DATA_FILE = ROOT / "data" / "figure2e" / "Fig2e_phase_angle.csv"
...
def main():
    ...
    output_path = FIG_DIR / "Fig2e_phase_state_comparison.svg"
