...
"""
Figure 2e — State-level Baseline Comparison by Race

This script generates the state-level comparison plot for the baseline
parameter (B), representing the average mobility level in the fitted
daily mobility rhythm model.

Each state is represented by a horizontal line connecting the baseline
...
figure_data/Figure2/Fig2e/Fig2e_baseline.csv
...
Output
------
visualization/Figure2/Fig2e/Fig2e_baseline_state_comparison.svg
...
DATA_FILE = ROOT / "data" / "figure2e" / "Fig2e_baseline.csv"
...
def main():
    ...
    output_path = FIG_DIR / "Fig2e_baseline_state_comparison.svg"
